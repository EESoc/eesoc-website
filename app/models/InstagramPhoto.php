...
class InstagramPhoto extends Eloquent {
	...
	public static function refresh($data)
	{
		...
		$photo->image_low_resolution_url      = str_replace('http://', 'https://', array_get($data, 'images.low_resolution.url'));
		$photo->image_thumbnail_url           = str_replace('http://', 'https://', array_get($data, 'images.thumbnail.url'));
		$photo->image_standard_resolution_url = str_replace('http://', 'https://', array_get($data, 'images.standard_resolution.url'));
